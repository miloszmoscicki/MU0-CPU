(function(root, factory) {
  ...
  function renderSetCookieHeader_0(name, value, encoding, maxAge, expires, domain, path, secure, httpOnly, extensions, includeEncoding) {
    ...
    if (includeEncoding) {
      ...
      tmp$_9 = '';
    var $receiver = plus_2(tmp$_8, tmp$_9);
  ...
  function UrlEncodingOption(name, ordinal, encodeKey, encodeValue) {
    Enum.call(this);
    this.encodeKey_8be2vx$ = encodeKey;
    this.encodeValue_8be2vx$ = encodeValue;
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function UrlEncodingOption_initFields() {
    UrlEncodingOption_initFields = function() {
};
    UrlEncodingOption$DEFAULT_instance = new UrlEncodingOption('DEFAULT', 0, true, true);
    UrlEncodingOption$KEY_ONLY_instance = new UrlEncodingOption('KEY_ONLY', 1, true, false);
    UrlEncodingOption$VALUE_ONLY_instance = new UrlEncodingOption('VALUE_ONLY', 2, false, true);
    UrlEncodingOption$NO_ENCODING_instance = new UrlEncodingOption('NO_ENCODING', 3, false, false);
  }
  var UrlEncodingOption$DEFAULT_instance;
  function UrlEncodingOption$DEFAULT_getInstance() {
    UrlEncodingOption_initFields();
    return UrlEncodingOption$DEFAULT_instance;
  }
  var UrlEncodingOption$KEY_ONLY_instance;
  function UrlEncodingOption$KEY_ONLY_getInstance() {
    UrlEncodingOption_initFields();
    return UrlEncodingOption$KEY_ONLY_instance;
  }
  var UrlEncodingOption$VALUE_ONLY_instance;
  function UrlEncodingOption$VALUE_ONLY_getInstance() {
    UrlEncodingOption_initFields();
    return UrlEncodingOption$VALUE_ONLY_instance;
  }
  var UrlEncodingOption$NO_ENCODING_instance;
  function UrlEncodingOption$NO_ENCODING_getInstance() {
    UrlEncodingOption_initFields();
    return UrlEncodingOption$NO_ENCODING_instance;
  }
  UrlEncodingOption.$metadata$ = {
  kind: Kind_CLASS, 
  simpleName: 'UrlEncodingOption', 
  interfaces: [Enum]};
  function UrlEncodingOption$values() {
    return [UrlEncodingOption$DEFAULT_getInstance(), UrlEncodingOption$KEY_ONLY_getInstance(), UrlEncodingOption$VALUE_ONLY_getInstance(), UrlEncodingOption$NO_ENCODING_getInstance()];
  }
  UrlEncodingOption.values = UrlEncodingOption$values;
  function UrlEncodingOption$valueOf(name) {
    switch (name) {
      case 'DEFAULT':
        return UrlEncodingOption$DEFAULT_getInstance();
      case 'KEY_ONLY':
        return UrlEncodingOption$KEY_ONLY_getInstance();
      case 'VALUE_ONLY':
        return UrlEncodingOption$VALUE_ONLY_getInstance();
      case 'NO_ENCODING':
        return UrlEncodingOption$NO_ENCODING_getInstance();
      default:
        throwISE('No enum constant io.ktor.http.UrlEncodingOption.' + name);
    }
  }
  UrlEncodingOption.valueOf_61zpoe$ = UrlEncodingOption$valueOf;
  ...
  function formUrlEncode($receiver) {
    return formUrlEncode_0($receiver, UrlEncodingOption$DEFAULT_getInstance());
  }
  function formUrlEncode_0($receiver, option) {
    if (option === void 0) 
      option = UrlEncodingOption$DEFAULT_getInstance();
    var $receiver_0 = StringBuilder_init_0();
    formUrlEncodeTo_0($receiver, $receiver_0, option);
    return $receiver_0.toString();
  }
  function formUrlEncodeTo($receiver, out) {
    formUrlEncodeTo_0($receiver, out, UrlEncodingOption$DEFAULT_getInstance());
  }
  function formUrlEncodeTo$lambda(closure$option) {
    return function(it) {
  var key = closure$option.encodeKey_8be2vx$ ? encodeURLParameter(it.first, true) : it.first;
  if (it.second == null) {
    return key;
  } else {
    var nonNullValue = toString(it.second);
    var value = closure$option.encodeValue_8be2vx$ ? encodeURLParameterValue(nonNullValue) : nonNullValue;
    return key + '=' + value;
  }
};
  }
  function formUrlEncodeTo_0($receiver, out, option) {
    if (option === void 0) 
      option = UrlEncodingOption$DEFAULT_getInstance();
    joinTo($receiver, out, '&', void 0, void 0, void 0, void 0, formUrlEncodeTo$lambda(option));
  }
  function formUrlEncode_1($receiver) {
    ...
    return formUrlEncode_0(destination, $receiver.urlEncodingOption);
  }
  function formUrlEncodeTo_1($receiver, out) {
    formUrlEncodeTo_4($receiver.entries(), out, $receiver.urlEncodingOption);
  }
  function formUrlEncodeTo_2($receiver, out) {
    formUrlEncodeTo_4($receiver.entries(), out, $receiver.urlEncodingOption);
  }
  function formUrlEncodeTo_3($receiver, out) {
    formUrlEncodeTo_4($receiver, out, UrlEncodingOption$DEFAULT_getInstance());
  }
  function formUrlEncodeTo_4($receiver, out, option) {
    if (option === void 0) 
      option = UrlEncodingOption$DEFAULT_getInstance();
    var destination = ArrayList_init_0();
    var tmp$;
    ...
    formUrlEncodeTo_0(destination, out, option);
  }
  ...
  Object.defineProperty(Parameters.prototype, 'urlEncodingOption', {
  configurable: true, 
  get: function() {
  return UrlEncodingOption$DEFAULT_getInstance();
}});
  ...
  simpleName: 'Parameters', 
  interfaces: [StringValues]};
  function ParametersBuilder(size, urlEncodingOption) {
    if (size === void 0) 
      size = 8;
    if (urlEncodingOption === void 0) 
      urlEncodingOption = UrlEncodingOption$DEFAULT_getInstance();
    StringValuesBuilder.call(this, true, size);
  ...
  this.built = true;
  return new ParametersImpl(this.values, this.urlEncodingOption);
};
  ParametersBuilder.$metadata$ = {
  kind: Kind_CLASS, 
  simpleName: 'ParametersBuilder', 
  interfaces: [StringValuesBuilder]};
  function ParametersBuilder_init(size, $this) {
    if (size === void 0) 
      size = 8;
    $this = $this || Object.create(ParametersBuilder.prototype);
    ParametersBuilder.call($this, size, UrlEncodingOption$DEFAULT_getInstance());
    return $this;
  }
  ...
  function ParametersImpl(values, urlEncodingOption) {
    if (values === void 0) 
      values = emptyMap();
    if (urlEncodingOption === void 0) 
      urlEncodingOption = UrlEncodingOption$DEFAULT_getInstance();
    StringValuesImpl.call(this, true, values);
    this.urlEncodingOption_ywf22t$_0 = urlEncodingOption;
  }
  Object.defineProperty(ParametersImpl.prototype, 'urlEncodingOption', {
  get: function() {
  return this.urlEncodingOption_ywf22t$_0;
}});
  ...
  function ParametersImpl_init(values, $this) {
    if (values === void 0) 
      values = emptyMap();
    $this = $this || Object.create(ParametersImpl.prototype);
    ParametersImpl.call($this, values, UrlEncodingOption$DEFAULT_getInstance());
    return $this;
  }
  ...
  function appendParam($receiver, query, nameIndex, equalIndex, endIndex) {
    ...
    if (equalIndex === -1) {
      ...
      if (spaceEndIndex > spaceNameIndex) {
        if ($receiver.urlEncodingOption.encodeKey_8be2vx$) 
      ...
      if (spaceEqualIndex > spaceNameIndex_0) {
        ...
        if ($receiver.urlEncodingOption.encodeValue_8be2vx$) 
  ...
  function pathComponents($receiver, components) {
    var destination = ArrayList_init(collectionSizeOrDefault(components, 10));
    var tmp$;
    ...
    loop_label:
      while (tmp$.hasNext()) {
        ...
        tmp$_0.call(destination, encodeURLQueryComponent(dropLastWhile$result));
      }
    var destination_0 = ArrayList_init_0();
    var tmp$_3;
    ...
    var paths = joinToString(destination_0, '/');
    if (!endsWith_0($receiver.encodedPath, 47)) {
      paths = '/' + paths;
    }
    $receiver.encodedPath += paths;
    return $receiver;
  }
  function pathComponents_0($receiver, components) {
    return pathComponents($receiver, toList_0(components));
  }
  ...
  function parseQuery($receiver, urlString, startIndex, endIndex) {
    ...
    var tmp$_0 = $receiver.parameters;
    var startIndex_0 = startIndex + 1 | 0;
    parseQueryStringTo(tmp$_0, urlString.substring(startIndex_0, fragmentStart));
  ...
  function takeFrom_0($receiver, url) {
    ...
    $receiver.parameters.urlEncodingOption = url.parameters.urlEncodingOption;
  ...
  function appendUrlFullPath_0($receiver, encodedPath, queryParameters, trailingQuery) {
    ...
    formUrlEncodeTo_2(queryParameters, $receiver);
  }
  function AuthScheme() {
  ...
  return new HttpAuthHeader$Parameterized(this.authScheme, plus_2(this.parameters, new HeaderValueParam(name, value)), this.encoding);
};
  ...
  Object.defineProperty(package$http, 'LETTERS_AND_NUMBERS_8be2vx$', {
  get: function() {
  return LETTERS_AND_NUMBERS;
}});
  Object.defineProperty(package$http, 'TOKENS_8be2vx$', {
  get: function() {
  return TOKENS;
}});
  ...
  Object.defineProperty(UrlEncodingOption, 'DEFAULT', {
  get: UrlEncodingOption$DEFAULT_getInstance});
  Object.defineProperty(UrlEncodingOption, 'KEY_ONLY', {
  get: UrlEncodingOption$KEY_ONLY_getInstance});
  Object.defineProperty(UrlEncodingOption, 'VALUE_ONLY', {
  get: UrlEncodingOption$VALUE_ONLY_getInstance});
  Object.defineProperty(UrlEncodingOption, 'NO_ENCODING', {
  get: UrlEncodingOption$NO_ENCODING_getInstance});
  package$http.UrlEncodingOption = UrlEncodingOption;
  package$http.parseUrlEncodedParameters_pu7mjb$ = parseUrlEncodedParameters;
  package$http.formUrlEncode_nyru4$ = formUrlEncode;
  package$http.formUrlEncode_vw30m7$ = formUrlEncode_0;
  package$http.formUrlEncodeTo_oiqysc$ = formUrlEncodeTo;
  package$http.formUrlEncodeTo_sjtcnv$ = formUrlEncodeTo_0;
  package$http.formUrlEncode_invt95$ = formUrlEncode_1;
  package$http.formUrlEncodeTo_ak0zj3$ = formUrlEncodeTo_1;
  package$http.formUrlEncodeTo_o3c3hx$ = formUrlEncodeTo_2;
  package$http.formUrlEncodeTo_askgr4$ = formUrlEncodeTo_3;
  package$http.formUrlEncodeTo_9ybn3t$ = formUrlEncodeTo_4;
  ...
  package$http.ParametersBuilder_init_za3lpa$ = ParametersBuilder_init;
  ...
  package$http.pathComponents_qmwsk$ = pathComponents;
  package$http.pathComponents_7buj3i$ = pathComponents_0;
  ...
  Object.defineProperty(EmptyParameters.prototype, 'urlEncodingOption', Object.getOwnPropertyDescriptor(Parameters.prototype, 'urlEncodingOption'));
  ...
  Object.defineProperty(ParametersSingleImpl.prototype, 'urlEncodingOption', Object.getOwnPropertyDescriptor(Parameters.prototype, 'urlEncodingOption'));
