(function (root, factory) {
  ...
  function Appearance$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant kotlinx.css.Appearance.' + name);
    }
  }
  ...
  function Isolation$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant kotlinx.css.Isolation.' + name);
    }
  }
  ...
  function JustifyItems$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant kotlinx.css.JustifyItems.' + name);
    }
  }
  ...
  function GradientSideOrCorner$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant kotlinx.css.properties.GradientSideOrCorner.' + name);
    }
  }
  ...
  function RadialGradientExtent$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant kotlinx.css.properties.RadialGradientExtent.' + name);
    }
  }
  ...
  Object.defineProperty(CssBuilder, 'Companion', {
