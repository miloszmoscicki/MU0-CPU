(function(root, factory) {
  ...
  if (!success) 
    return;
  var installedFeatures = this.attributes.get_yzaw86$(FEATURE_INSTALLED_LIST);
  var tmp$;
  tmp$ = installedFeatures.allKeys.iterator();
  while (tmp$.hasNext()) {
    var element = tmp$.next();
    var tmp$_0;
    var feature = installedFeatures.get_yzaw86$(Kotlin.isType(tmp$_0 = element, AttributeKey) ? tmp$_0 : throwCCE());
