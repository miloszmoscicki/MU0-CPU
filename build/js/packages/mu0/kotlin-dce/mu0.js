(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'mu0'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'mu0'.");
    }if (typeof react === 'undefined') {
      throw new Error("Error loading module 'mu0'. Its dependency 'react' was not found. Please, check whether 'react' is loaded prior to 'mu0'.");
    }if (typeof this['kotlin-react'] === 'undefined') {
      throw new Error("Error loading module 'mu0'. Its dependency 'kotlin-react' was not found. Please, check whether 'kotlin-react' is loaded prior to 'mu0'.");
    }if (typeof this['kotlinx-html-js'] === 'undefined') {
      throw new Error("Error loading module 'mu0'. Its dependency 'kotlinx-html-js' was not found. Please, check whether 'kotlinx-html-js' is loaded prior to 'mu0'.");
    }if (typeof this['kotlin-react-dom'] === 'undefined') {
      throw new Error("Error loading module 'mu0'. Its dependency 'kotlin-react-dom' was not found. Please, check whether 'kotlin-react-dom' is loaded prior to 'mu0'.");
    }if (typeof this['kotlin-css'] === 'undefined') {
      throw new Error("Error loading module 'mu0'. Its dependency 'kotlin-css' was not found. Please, check whether 'kotlin-css' is loaded prior to 'mu0'.");
    }if (typeof this['kotlin-styled'] === 'undefined') {
      throw new Error("Error loading module 'mu0'. Its dependency 'kotlin-styled' was not found. Please, check whether 'kotlin-styled' is loaded prior to 'mu0'.");
    }if (typeof this['ktor-ktor-io-js-legacy'] === 'undefined') {
      throw new Error("Error loading module 'mu0'. Its dependency 'ktor-ktor-io-js-legacy' was not found. Please, check whether 'ktor-ktor-io-js-legacy' is loaded prior to 'mu0'.");
    }root.mu0 = factory(typeof mu0 === 'undefined' ? {} : mu0, kotlin, react, this['kotlin-react'], this['kotlinx-html-js'], this['kotlin-react-dom'], this['kotlin-css'], this['kotlin-styled'], this['ktor-ktor-io-js-legacy']);
  }
  ...
  MemUpdate.$metadata$ = {kind: Kind_CLASS, simpleName: 'MemUpdate', interfaces: []};
  ...
  InputT$Companion.$metadata$ = {kind: Kind_OBJECT, simpleName: 'Companion', interfaces: []};
  ...
  InputT.$metadata$ = {kind: Kind_CLASS, simpleName: 'InputT', interfaces: [Enum]};
  ...
  ACC_STATE.$metadata$ = {kind: Kind_CLASS, simpleName: 'ACC_STATE', interfaces: [Enum]};
  ...
  ACC.$metadata$ = {kind: Kind_OBJECT, simpleName: 'ACC', interfaces: [HardwareBlock]};
  ...
  ALU_OP.$metadata$ = {kind: Kind_CLASS, simpleName: 'ALU_OP', interfaces: [Enum]};
  ...
  ALU.$metadata$ = {kind: Kind_OBJECT, simpleName: 'ALU', interfaces: [HardwareBlock]};
  ...
  ACTION_BLOCK.$metadata$ = {kind: Kind_CLASS, simpleName: 'ACTION_BLOCK', interfaces: [Enum]};
  ...
  Control$ProcessorStateChange.$metadata$ = {kind: Kind_CLASS, simpleName: 'ProcessorStateChange', interfaces: []};
  ...
  Control$InstructionEffect.$metadata$ = {kind: Kind_CLASS, simpleName: 'InstructionEffect', interfaces: []};
  ...
  Control$SyscallTypes$Companion.$metadata$ = {kind: Kind_OBJECT, simpleName: 'Companion', interfaces: []};
  ...
  Control$SyscallTypes.$metadata$ = {kind: Kind_CLASS, simpleName: 'SyscallTypes', interfaces: [Enum]};
  ...
  Control.$metadata$ = {kind: Kind_CLASS, simpleName: 'Control', interfaces: []};
  ...
  HardwareBlock.$metadata$ = {kind: Kind_CLASS, simpleName: 'HardwareBlock', interfaces: []};
  ...
  IR_STATE.$metadata$ = {kind: Kind_CLASS, simpleName: 'IR_STATE', interfaces: [Enum]};
  ...
  IR.$metadata$ = {kind: Kind_OBJECT, simpleName: 'IR', interfaces: [HardwareBlock]};
  ...
  MAR.$metadata$ = {kind: Kind_OBJECT, simpleName: 'MAR', interfaces: [HardwareBlock]};
  ...
  MDR_STATE.$metadata$ = {kind: Kind_CLASS, simpleName: 'MDR_STATE', interfaces: [Enum]};
  ...
  MDR.$metadata$ = {kind: Kind_OBJECT, simpleName: 'MDR', interfaces: [HardwareBlock]};
  ...
  Object.defineProperty(Main.prototype, 'cpu', {configurable: true, get: function () {
  ...
  Main.$metadata$ = {kind: Kind_CLASS, simpleName: 'Main', interfaces: []};
  ...
  Memory.$metadata$ = {kind: Kind_OBJECT, simpleName: 'Memory', interfaces: []};
  ...
  PC.$metadata$ = {kind: Kind_OBJECT, simpleName: 'PC', interfaces: [HardwareBlock]};
  ...
  MemorySetupOutput.$metadata$ = {kind: Kind_CLASS, simpleName: 'MemorySetupOutput', interfaces: []};
  ...
  Preprocess.$metadata$ = {kind: Kind_CLASS, simpleName: 'Preprocess', interfaces: []};
  function Sim(memory) {
  ...
  Sim.$metadata$ = {kind: Kind_CLASS, simpleName: 'Sim', interfaces: []};
  ...
  Object.defineProperty(InputT, 'HEX', {get: InputT$HEX_getInstance});
  Object.defineProperty(InputT, 'ASM', {get: InputT$ASM_getInstance});
  Object.defineProperty(InputT, 'BIN', {get: InputT$BIN_getInstance});
  Object.defineProperty(InputT, 'Companion', {get: InputT$Companion_getInstance});
  _.InputT = InputT;
  _.main = main;
  Object.defineProperty(ACC_STATE, 'STORE', {get: ACC_STATE$STORE_getInstance});
  Object.defineProperty(ACC_STATE, 'LOAD', {get: ACC_STATE$LOAD_getInstance});
  Object.defineProperty(ACC_STATE, 'ALU_OP', {get: ACC_STATE$ALU_OP_getInstance});
  Object.defineProperty(ACC_STATE, 'JUMP', {get: ACC_STATE$JUMP_getInstance});
  var package$Sim = _.Sim || (_.Sim = {});
  package$Sim.ACC_STATE = ACC_STATE;
  Object.defineProperty(package$Sim, 'ACC', {get: ACC_getInstance});
  Object.defineProperty(ALU_OP, 'ADD', {get: ALU_OP$ADD_getInstance});
  Object.defineProperty(ALU_OP, 'SUBSTRACT', {get: ALU_OP$SUBSTRACT_getInstance});
  Object.defineProperty(ALU_OP, 'MULTIPLY', {get: ALU_OP$MULTIPLY_getInstance});
  Object.defineProperty(ALU_OP, 'DIVIDE', {get: ALU_OP$DIVIDE_getInstance});
  Object.defineProperty(ALU_OP, 'AND', {get: ALU_OP$AND_getInstance});
  Object.defineProperty(ALU_OP, 'OR', {get: ALU_OP$OR_getInstance});
  Object.defineProperty(ALU_OP, 'JMP', {get: ALU_OP$JMP_getInstance});
  Object.defineProperty(ALU_OP, 'JGE', {get: ALU_OP$JGE_getInstance});
  Object.defineProperty(ALU_OP, 'JNE', {get: ALU_OP$JNE_getInstance});
  Object.defineProperty(ALU_OP, 'LDI', {get: ALU_OP$LDI_getInstance});
  Object.defineProperty(ALU_OP, 'NONE', {get: ALU_OP$NONE_getInstance});
  package$Sim.ALU_OP = ALU_OP;
  Object.defineProperty(package$Sim, 'ALU', {get: ALU_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'ACC', {get: ACTION_BLOCK$ACC_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'ALU', {get: ACTION_BLOCK$ALU_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'CON', {get: ACTION_BLOCK$CON_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'IR', {get: ACTION_BLOCK$IR_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'MAR', {get: ACTION_BLOCK$MAR_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'MDR', {get: ACTION_BLOCK$MDR_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'MEM', {get: ACTION_BLOCK$MEM_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'PC', {get: ACTION_BLOCK$PC_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'MEMMDR', {get: ACTION_BLOCK$MEMMDR_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'MARMEM', {get: ACTION_BLOCK$MARMEM_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'MDRACC', {get: ACTION_BLOCK$MDRACC_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'ACCALU', {get: ACTION_BLOCK$ACCALU_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'ALUACC', {get: ACTION_BLOCK$ALUACC_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'MDRALU', {get: ACTION_BLOCK$MDRALU_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'MDRIR', {get: ACTION_BLOCK$MDRIR_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'IRMAR', {get: ACTION_BLOCK$IRMAR_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'IRCON', {get: ACTION_BLOCK$IRCON_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'PCMAR', {get: ACTION_BLOCK$PCMAR_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'IRPC', {get: ACTION_BLOCK$IRPC_getInstance});
  Object.defineProperty(ACTION_BLOCK, 'IRALU', {get: ACTION_BLOCK$IRALU_getInstance});
  ...
  Object.defineProperty(Control$SyscallTypes, 'PRINT_INT', {get: Control$SyscallTypes$PRINT_INT_getInstance});
  Object.defineProperty(Control$SyscallTypes, 'PRINT_FLOAT', {get: Control$SyscallTypes$PRINT_FLOAT_getInstance});
  Object.defineProperty(Control$SyscallTypes, 'PRINT_STRING', {get: Control$SyscallTypes$PRINT_STRING_getInstance});
  Object.defineProperty(Control$SyscallTypes, 'Companion', {get: Control$SyscallTypes$Companion_getInstance});
  Control.SyscallTypes = Control$SyscallTypes;
  package$Sim.Control = Control;
  package$Sim.HardwareBlock = HardwareBlock;
  Object.defineProperty(IR_STATE, 'MAR', {get: IR_STATE$MAR_getInstance});
  Object.defineProperty(IR_STATE, 'ALU', {get: IR_STATE$ALU_getInstance});
  Object.defineProperty(IR_STATE, 'PC', {get: IR_STATE$PC_getInstance});
  Object.defineProperty(IR_STATE, 'NONE', {get: IR_STATE$NONE_getInstance});
  package$Sim.IR_STATE = IR_STATE;
  Object.defineProperty(package$Sim, 'IR', {get: IR_getInstance});
  Object.defineProperty(package$Sim, 'MAR', {get: MAR_getInstance});
  Object.defineProperty(MDR_STATE, 'FETCH', {get: MDR_STATE$FETCH_getInstance});
  Object.defineProperty(MDR_STATE, 'STORE', {get: MDR_STATE$STORE_getInstance});
  Object.defineProperty(MDR_STATE, 'LOAD', {get: MDR_STATE$LOAD_getInstance});
  Object.defineProperty(MDR_STATE, 'ALU_OP', {get: MDR_STATE$ALU_OP_getInstance});
  package$Sim.MDR_STATE = MDR_STATE;
  Object.defineProperty(package$Sim, 'MDR', {get: MDR_getInstance});
  package$Sim.Main = Main;
  Object.defineProperty(package$Sim, 'Memory', {get: Memory_getInstance});
  Object.defineProperty(package$Sim, 'PC', {get: PC_getInstance});
