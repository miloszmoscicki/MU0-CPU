(function (root, factory) {
  ...
  function inputComponent$lambda($receiver, props) {
    ...
    set_height($receiver_7, new LinearDimension('250px'));
    ...
    set_fontSize($receiver_10, new LinearDimension('12px'));
  ...
  function logger$lambda($receiver, props) {
    ...
    set_height($receiver_1, new LinearDimension('100px'));
